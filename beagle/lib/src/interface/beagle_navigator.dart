...
abstract class BeagleNavigator {
  ...
  Future<void> pushStack(BeagleRoute route, BuildContext context, [String controllerId]);
  ...
  ///
  /// Returns a Future that resolves as soon as the navigation completes.
  Future<void> resetStack(BeagleRoute route, BuildContext context, [String controllerId]);
  ...
  ///
  /// Returns a Future that resolves as soon as the navigation completes.
  Future<void> resetApplication(BeagleRoute route, BuildContext context, [String controllerId]);
}
