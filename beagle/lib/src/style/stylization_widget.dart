...
class StylizationWidget {
  ...
  Widget _applyStyle(Widget origin, BeagleStyle? style) {
    final backgroundColor = _getBackgroundColor(style?.backgroundColor);
    final border = _getBorder(style?.borderColor, style?.borderWidth);
  ...
  Border? _getBorder(String? borderColor, double? borderWidth) {
    return borderWidth != null && borderColor != null
        ? Border.all(
