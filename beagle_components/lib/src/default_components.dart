...
ComponentBuilder beagleTextBuilder() {
  return (element, _, __) => BeagleText(
      ...
      textColor: BeagleCaster.castToString(
          element.getAttributeValue('textColor'),
          defaultValue: null),
      styleId: BeagleCaster.castToString(element.getAttributeValue('styleId'),
          defaultValue: null),
      alignment: EnumUtils.fromString(
            TextAlignment.values,
            BeagleCaster.castToString(element.getAttributeValue('alignment'),
                defaultValue: null),
          ) ??
          TextAlignment.LEFT);
}
...
ComponentBuilder beagleContainerBuilder() {
  return (element, children, _) => BeagleContainer(
      key: element.getKey(),
      onInit: BeagleCaster.castToNullableFunction(
          element.getAttributeValue('onInit')),
...
ComponentBuilder beagleListViewBuilder() {
  return (element, children, _) => BeagleDynamicList(
      ...
      scrollEndThreshold: BeagleCaster.castToInt(
          element.getAttributeValue('scrollEndThreshold'),
          defaultValue: null),
...
ComponentBuilder beagleTextInputBuilder() {
  return (element, _, __) => BeagleTextInput(
      key: element.getKey(),
      onChange: BeagleCaster.castToNullableFunction(
          element.getAttributeValue('onChange')),
      onFocus: BeagleCaster.castToNullableFunction(
      ...
      value: BeagleCaster.castToString(element.getAttributeValue('value'),
          defaultValue: null),
      readOnly: BeagleCaster.castToBool(element.getAttributeValue('readOnly'),
          defaultValue: false),
      enabled: BeagleCaster.castToBool(element.getAttributeValue('enabled'),
          defaultValue: true),
      error: BeagleCaster.castToString(element.getAttributeValue('error'),
          defaultValue: null),
...
ComponentBuilder beagleButtonBuilder() {
  return (element, _, __) => BeagleButton(
      key: element.getKey(),
      onPress: BeagleCaster.castToNullableFunction(
          element.getAttributeValue('onPress')),
      text: BeagleCaster.castToString(element.getAttributeValue('text'),
          defaultValue: null),
      enabled: BeagleCaster.castToBool(element.getAttributeValue('enabled'),
          defaultValue: true),
...
ComponentBuilder beagleLazyComponentBuilder() {
  return (element, children, view) {
    ...
    return BeagleLazyComponent(
        key: element.getKey(),
        path: BeagleCaster.castToString(element.getAttributeValue('path'),
            defaultValue: null),
        initialState:
...
ComponentBuilder beagleTabBarBuilder() {
  return (element, _, __) {
    ...
    return BeagleTabBar(
        ...
        currentTab: BeagleCaster.castToInt(
            element.getAttributeValue('currentTab'),
            defaultValue: null),
        onTabSelection: BeagleCaster.cast<void Function(int)?>(
            element.getAttributeValue('onTabSelection'), null));
  };
}
...
ComponentBuilder beaglePageViewBuilder() {
  return (element, children, __) => BeaglePageView(
        key: element.getKey(),
        currentPage: BeagleCaster.castToInt(
            element.getAttributeValue('currentPage'),
            defaultValue: null),
        onPageChange: BeagleCaster.cast<void Function(int)?>(
            element.getAttributeValue('onPageChange'), null),
        children: BeagleCaster.castToList<Widget>(children),
      );
}
...
ComponentBuilder beagleImageBuilder() {
  return (element, _, __) {
    return BeagleImage(
        key: element.getKey(),
        path: element.getAttributeValue('path') != null
            ? ImagePath.fromJson(element.getAttributeValue('path'))
            : null,
...
ComponentBuilder beaglePageIndicatorBuilder() {
  return (element, _, __) => BeaglePageIndicator(
      key: element.getKey(),
      selectedColor: BeagleCaster.castToString(
          element.getAttributeValue('selectedColor'),
          defaultValue: null),
      unselectedColor: BeagleCaster.castToString(
          element.getAttributeValue('unselectedColor'),
          defaultValue: null),
      numberOfPages: BeagleCaster.castToInt(
          element.getAttributeValue('numberOfPages'),
          defaultValue: null),
      currentPage: BeagleCaster.castToInt(
          element.getAttributeValue('currentPage'),
          defaultValue: null));
...
ComponentBuilder beagleTouchableBuilder() {
  return (element, children, __) => BeagleTouchable(
      key: element.getKey(),
      onPress: BeagleCaster.cast<void Function()?>(
          element.getAttributeValue('onPress'), null),
...
ComponentBuilder beagleWebViewBuilder() {
  return (element, children, __) => BeagleWebView(
        key: element.getKey(),
        url: BeagleCaster.castToString(element.getAttributeValue('url'),
            defaultValue: null),
      );
}
...
ComponentBuilder beagleScreenComponentBuilder() {
  return (element, children, _) {
    final Map<String, dynamic> safeArea =
        BeagleCaster.castToMap<String, dynamic>(
    ...
    return BeagleScreen(
        key: element.getKey(),
        identifier: BeagleCaster.castToString(
            element.getAttributeValue('identifier'),
            defaultValue: null),
        safeArea:
            safeArea.isNotEmpty ? BeagleSafeArea.fromJson(safeArea) : null,
...
ComponentBuilder beaglePullToRefreshBuilder() {
  return (element, children, view) {
    return PullToRefresh(
        key: element.getKey(),
        onPull: BeagleCaster.castToNullableFunction(
            element.getAttributeValue('onPull')),
        isRefreshing: BeagleCaster.castToBool(
            element.getAttributeValue('isRefreshing'),
            defaultValue: false),
        color: BeagleCaster.castToString(element.getAttributeValue('color'),
            defaultValue: null),
...
ComponentBuilder beagleSimpleFormBuilder() {
  return (element, children, view) {
    return BeagleSimpleForm(
        key: element.getKey(),
        onSubmit: BeagleCaster.castToNullableFunction(
            element.getAttributeValue('onSubmit')),
        onValidationError: BeagleCaster.castToNullableFunction(
            element.getAttributeValue('onValidationError')),
        children: BeagleCaster.castToList<Widget>(children));
  };
}
